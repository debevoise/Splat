  ...
  render () {
    return (
      <div className="about-modal-container">
        ...
        <a href="https://github.com/debevoise" target="_blank" rel="noopener noreferrer">
        ...
        <a href="https://github.com/hm-factor" target="_blank" rel="noopener noreferrer">
          <i className="fab fa-github"></i>GitHub
        </a>

        <h4>Phillip - Flex Dev</h4>
        <a href="https://github.com/ParaLogia" target="_blank" rel="noopener noreferrer">
          <i className="fab fa-github"></i>GitHub
        </a>
